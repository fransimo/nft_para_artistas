...
def generate_nft(init_extraction, rewinds=3.5, capture=2, text_index=-1):
    texts = ["En los blockchains\ncapaces de contener NFTs \ntodas las operaciones \nson públicas.",
             "Not your keys,\n    not your coins!",
    ...
    if text_index == -1:
        text_index = random.randint(0, end)
    text = texts[text_index]
    add_text_layer_gif('/tmp/tmp.gif', dest, text)


# get_frames('00:01:00')
generate_nft('00:01:13', text_index=0)
exit(0)
...
# get_frames('00:20:19')
generate_nft('00:20:51', text_index=0)
# get_frames('00:21:06')
# get_frames('00:21:34')
...
generate_nft('00:28:07', text_index=0)
...
generate_nft('01:00:33', rewinds=0, capture=2, text_index=0)
generate_nft('01:06:10', rewinds=1, capture=5, text_index=0)
# get_frames('01:11:23')
generate_nft('01:16:49')
generate_nft('01:22:24', rewinds=2, capture=3, text_index=0)
generate_nft('01:22:30', rewinds=2, capture=3, text_index=0)
